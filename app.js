...
console.log("cel",temperatureCelsius)
console.log("faren", tempFahrenheit)
...
// const cel = parseFloat(input)

// const fahren = (cel * (9/5)) + 32

// console.log(`${cel} is equal to ${fahren}`)
// alert(`${cel} is equal to ${fahren}`)
...
// const expense1 = Number(prompt("1-chi expenseni kiriting: "))
// const expense2 = Number(prompt("2-chi expenseni kiriting: "))
// const expense3 = Number(prompt("3-chi expenseni kiriting: "))

// const balance = budget - (expense1 + expense2 + expense3)

// if(balance < 0){
//     alert("puling yetmaydi")
// } else {
//     alert("pul kop hali")
// }
