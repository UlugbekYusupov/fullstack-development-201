const DB = [
    { id: 1, username: 'timmy', email: 'timmy210@mail.ru', password: 'tim123three' },
    { id: 2, username: 'jhon138', email: 'jhonmedoe@yandex.ru', password: 'hiddenpass123' },
    { id: 3, username: 'micheal', email: 'mii3@gmail.com', password: 'michel12DEV' },
    { id: 4, username: 'abbosjon', email: 'admin@gnail.com', password: 'admin123' }
]
...
signupB.addEventListener('click', function (e) {
    ...
    if (user) {
        showAlert("User already registered, try again with another credetails", 'error')
        return 0;
    }
    ...
    showAlert("Yo're successfully registered!")
    setTimeout(() => {
